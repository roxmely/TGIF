...
if (page == "houseattendance.html") {
  url = "https://api.propublica.org/congress/v1/113/house/members.json";
  var pageType = "house";
}
if (page == "senateattendance.html") {
...
function start() {
  if (page == "houseattendance.html" || page == "senateattendance.html") {
    party(members);
    put(members);
...
// put(members);
// con sort ordeno el array y con la funcion b-a, me devuelve ordenado de mayor a menor.
function leastEngaged(least) {
  ...
  for (var j = 0; j < tenpercent; j++) {
    ...
    missedCell.innerHTML = senate.missed_votes;
    pctCell.innerHTML = senate.missed_votes_pct + "%";
